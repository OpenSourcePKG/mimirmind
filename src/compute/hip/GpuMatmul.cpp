...
struct GpuMatmul::Impl {
    ...
    ::mimirmind::core::hip::HipModule _moeGateUpFusedKQ4KModule;
    ::mimirmind::core::hip::HipKernel _moeGateUpFusedKQ4KKernel;
    ...
    ::mimirmind::core::hip::HipModule _matmulQ3KVecModule;
    ::mimirmind::core::hip::HipKernel _matmulQ3KVecKernel;
    ...
    explicit Impl(::mimirmind::core::hip::HipContext& ctx)
        : _matmulQ8_0VecModule    {loadHipModule(ctx, "matmul_q8_0_vec")},
          ...
          _moeGateUpFusedKQ4KModule{loadHipModule(ctx, "moe_gate_up_fused_k_q4k")},
          _moeGateUpFusedKQ4KKernel{
              _moeGateUpFusedKQ4KModule.getKernel("moe_gate_up_fused_k_q4k")},
          ...
          _matmulQ3KVecModule     {loadHipModule(ctx, "matmul_q3k_vec")},
          _matmulQ3KVecKernel     {
              _matmulQ3KVecModule.getKernel("matmul_q3k_vec")},
      ...
      _pimpl{std::make_unique<Impl>(ctx.hipContext())}
{
    MM_LOG_INFO("hip::GpuMatmul",
                "compute::hip::GpuMatmul ready — 12 kernels loaded "
...
void GpuMatmul::moeGateUpFusedKAsync(::mimirmind::core::gguf::GgmlType type,
    ...
    if (type != ::mimirmind::core::gguf::GgmlType::Q4_K) {
        throw std::runtime_error(
            "compute::hip::GpuMatmul::moeGateUpFusedKAsync: only Q4_K "
            "supported on the HIP side — check moeGateUpFusedKAvailable(type) "
            "before dispatching.");
    }
    ...
    if (dModel % 256 != 0) {
        throw std::runtime_error(
            "compute::hip::GpuMatmul::moeGateUpFusedKAsync: dModel=" +
